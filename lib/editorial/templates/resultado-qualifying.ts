...
export const resultadoQualifyingTemplate: EditorialTemplate = {
  ...
  bodyStructure: [
    "Paragrafo 1: O lead da classificacao - quem garantiu a pole position, o tempo da volta mais rapida se disponivel e o feito da equipe.",
    "Paragrafo 2: As primeiras filas - as posicoes do top 3/top 5 no grid de largada e a diferenca de ritmo.",
    "Paragrafo 3: A evolucao da sessao - pilotos eliminados precocemente no Q1 ou Q2, incidentes na pista e surpresas no top 10.",
    "Paragrafo 4: Classificacao Final / Grid de Largada - Uma lista markdown clara mostrando a ordem completa das posicoes de largada oficiais (ex: P1. Piloto [Equipe], P2. Piloto [Equipe]...).",
  ],
  customInstructions: `
